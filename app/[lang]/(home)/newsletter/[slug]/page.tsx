  ...
  return <main className="nl-container nl-article-page">
    ...
    <article lang={post.locale}>
      ...
      <div className="nl-reading-layout">
        ...
        <div className="nl-reading-content"><ArticleBody html={post.html} locale={locale} />{post.updatedAt !== post.publishedAt && <p className="nl-updated" lang={locale}>{copy.updated} {dateLabel(post.updatedAt, locale)}</p>}</div>
      </div>
    </article>
