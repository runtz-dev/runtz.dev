...
La CLI de runtz es un único binario estático en Go. El script detecta el sistema operativo y la arquitectura, descarga el binario y lo instala en `/usr/local/bin`:
...
Linux y macOS son compatibles con `amd64` y `arm64`.
